...
function custom_post_type1() {
	...
	$labels1 = array(
		...
		'add_new'               => __( 'Добавить риложение', 'text_domain' ),
		'new_item'              => __( 'New Item', 'text_domain' ),
		'edit_item'             => __( 'Edit Item', 'text_domain' ),
		'update_item'           => __( 'Update Item', 'text_domain' ),
		'view_item'             => __( 'View Item', 'text_domain' ),
...
function hutson_scripts() {
	...
	wp_enqueue_style( 'hutson-owl.carousel.min', get_template_directory_uri() . '/css/owl.carousel.min.css' );
	wp_enqueue_style( 'hutson-owl.theme.default.min', get_template_directory_uri() . '/css/owl.theme.default.min.css' );
	wp_enqueue_style( 'hutson-all', get_template_directory_uri() . '/css/awesome/css/all.css' );
	...
	wp_enqueue_script( 'hutson-owl.carousel.min', get_template_directory_uri() . '/js/owl.carousel.min.js', array(), '20151215', true );
