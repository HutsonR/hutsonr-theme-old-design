...
$(document).ready(function () {
  ...
  function ChangeTheme() {
    let lightTheme =
      "https://hutsonr.ru/wp-content/themes/hutson/css/light.css";
    let darkTheme = "https://hutsonr.ru/wp-content/themes/hutson/css/dark.css";
  ...
  function Save(theme) {
    ...
    Request.open("GET", "https://hutsonr.ru/wp-content/themes/hutson/themes.php?theme=" + theme, true); //У вас путь может отличаться
    Request.send();
  }
});
...
// Закрытие меню постов при клике
$(".menu-overlay").click(function () {
  $(".menu-overlay").toggleClass("active-menu");
  $(".menu").toggleClass("active-menu");
  $("body").toggleClass("locked");
});
// Открытие меню постов при клике
$(".post-menu-btn").click(function () {
  $(".post-menu-overlay").toggleClass("open-menu");
  $(".post-menu").toggleClass("open-menu");
  $("body").toggleClass("locked");
});
// Закрытие меню постов при клике
$(".post-menu-overlay").click(function () {
  $(".post-menu-overlay").toggleClass("open-menu");
  $(".post-menu").toggleClass("open-menu");
  $("body").toggleClass("locked");
});
...
$(document).ready(function () {
  $("#scroll_desk").on("click", "a", function (event) {
